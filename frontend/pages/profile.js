...
export default function Profile() {
  ...
  return (
    <div className="bg-[hsl(207,50%,90%)] min-h-screen pt-10">
      <Head>
        <title>Profile Page</title>
      </Head>

      {/* Main Content */}
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8 p-10 rounded-2xl">
        ...
        <div className="flex flex-col items-center md:items-start w-full md:w-1/3">
          ...
          {user_photo ? (
            ...
            <div className="w-28 h-28 rounded-full bg-gray-100 flex items-center justify-center text-5xl font-bold mb-4 shadow-lg">
          ...
          <label className="cursor-pointer bg-gray-100 px-4 py-2 rounded shadow hover:bg-[#FBE3D1] hover:text-[#B8D2D8] mt-2 transition shadow-xl inline-block">
            <input
              type="file"
              accept="image/*"
              className="hidden"
          ...
          <button
            onClick={() => clickEditUserButton(profile)}
            className="bg-gray-100 px-4 py-2 rounded shadow hover:bg-[#FBE3D1] hover:text-[#B8D2D8] mt-2 transition shadow-xl"
          >
            Edit Profile Data
          </button>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-6">
          {/* Bio Card */}
          <div className="bg-gray-100 rounded-xl p-6 shadow-xl">
